      ...
      <div className="w-full h-full relative flex flex-col gap-40">
        <div className="flex flex-col gap-40">
          <div className="relative">
            ...
            <p
              className="text-4xl md:text-[clamp(3rem,1.5rem+8vw,3.375rem)] md:leading-[clamp(3rem,1.5rem+8vw,3.5rem)] font-medium indent-28.75"
              dangerouslySetInnerHTML={{ __html: aboutData.heading.paragraph }}
            ></p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="divide-y divide-white flex flex-col">
              {skill.items.map((lang, i) => (
                <li className="hover:bg-white hover:text-black group" key={i}>
                  <Paragraph className="py-3 group-hover:translate-x-2 transition-transform">
                    {lang}
                  </Paragraph>
                </li>
              ))}
...
export function Approach() {
  return (
    <div id="approach" className="max-w-52.5">
